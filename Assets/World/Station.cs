...
public class Station : VoxelObject
{
    ...
    private List<Mesh> DrawBlock(int CircumferencePos, int LengthPos, int RadiusPos)
    {
        ...
        { // +C face
            ...
            if (otherBlock == null
                || otherBlock.type == 0
                || !otherBlock.otherFaces[1])
            { // +C face, so check other block's -C face
        ...
        { // +Y face
            ...
            if (otherBlock == null
                || otherBlock.type == 0
                || !otherBlock.otherFaces[3])
            { // +Y face, so check other block's -Y face
        ...
        { // +R face
            ...
            if (otherBlock == null
                || otherBlock.type == 0
                || !otherBlock.otherFaces[5])
            { // +R face, so check other block's -R face
