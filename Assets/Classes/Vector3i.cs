...
/// <summary>
/// 3-element structure that can be used to represent 3D grid coordinates or pairs of integers.
/// </summary>
...
public struct Vector3i : IEquatable<Vector3i>
{
    ...
    {
        Vector3i v = this;
        v.x = MathfEx.PosMod(v.x, mod);
        v.y = MathfEx.PosMod(v.y, mod);
        v.z = MathfEx.PosMod(v.z, mod);
        return v;
    }
    ...
    {
        Vector3i v = this;
        v.x = MathfEx.PosMod(v.x, modv.x);
        v.y = MathfEx.PosMod(v.y, modv.y);
        v.z = MathfEx.PosMod(v.z, modv.z);
        return v;
    }
    ...
    public static Vector3i NegOne { get { return _negOne; } }
    ...
    // Constructors
    public Vector3i(real_t x, real_t y, real_t z)
    {
        this.x = Mathf.RoundToInt(x);
        this.y = Mathf.RoundToInt(y);
        this.z = Mathf.RoundToInt(z);
